...
class CompetitionForm extends FormBase { 
	/**
     ...
     public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        ->fields('t', ['Offers_Field']);		
		$result = $query->execute()->fetchAll();
		$Offers_Field = "";		
		foreach ($result as $row) {			
			$Offers_Field = $row->Offers_Field;
		}	
        ...
        $form['house'] = array (
			...
			'#maxlength' => 255,
            '#prefix' => '<br><hr><br>
            <p>If you&acute;re a lucky winner, tell us where to deliver your prize</p><br><div class="label-wrap">',
            '#suffix' => '</div>',
        );  
        ...
        $form['terms'] = array(
            ...
            '#id' => 'terms',
            '#type' => 'checkbox',			
            '#title' => t('I agree to the <a href="/prize-draw-tcs">terms and conditions</a>'),
			'#required' => TRUE,
	...
	public function validateForm(array &$form, FormStateInterface $form_state) {
		...
		$entrant_con = \Drupal\Core\Database\Database::getConnection('default','entrants'); 
		...
		if ($count > 0 ) {		
			$form_state->setErrorByName('answer', $this->t('Sorry - you have already had a go.'));				
		}
